...
Fac=c(1,1,1,1)
mx <- asca.design.matrix(i,j,r,time)
effect_df.original <- effect(ASCA.2f,plot = T,var=0.2,neg = N,method = 'asca_original',effect = 'variables')
effect_df.improved <- effect(ASCA.2f_leverage,plot = T,var=0.2,neg=N,method = 'asca_improved',effect = 'variables')
```
