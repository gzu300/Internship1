...
for (each in N){
  ...
  asca.fitted.original <- fitted(df.final,asca.fit,groups,1,ASCA.2f)
  plot.leverage_spe(asca.fitted.original)
  print(data.frame(stats(asca.fitted.original$stats_for_plot)))
}
```
