...
ftrs_in_pat <- list(15,15,1,55-25)
...
sim_favor_masigpro_pattern <- plot_a_metabolite(df.final.masigpro,mean,colnames[1],tag='A')
...
wrapped_info_favor_masigpro <- wrap.permutation.info(df.final = df.final.asca,asca.fit = asca.fit,groups = groups,R = 100,which_leverage = ASCA.2f_leverage)
