...
wrapped_info_simreal_improved <- wrap.permutation.info(df.final = df.final.asca,asca.fit = asca.fit,groups = groups,R = 100,which_leverage = ASCA.2f_leverage)
...
wrapped_info_simreal_original <- wrap.permutation.info(df.final = df.final.asca,asca.fit = asca.fit.original,groups = groups,R = 100,which_leverage = ASCA.2f)
...
save(list = c('sim_real_pattern','sim_real_pattern3','df.var.realdata','ascaonly','masigproonly','sim_favor_asca_pattern','sim_favor_asca','sim_favor_masigpro_pattern','sim_favor_masigpro','lev_spe_improved','violin_improved','lev_spe_original','violin_original'),file = 'data.RData')
