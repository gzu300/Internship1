...
# save(list = c('df.var.realdata','asca.selected','asca.original.selected','improved_loading.pc1','original_loading.pc1', 'venn_list','ascaonly','masigproonly'),file = 'data.RData')
```
