...
asca.fitted <- fitted(df.final.asca,asca.fit,groups,50,ASCA.2f_leverage)
...
asca.original.fitted <- fitted(df.final.asca,asca.fit.original,groups,50,ASCA.2f)
asca.original.selected <- plot.leverage_spe(asca.original.fitted,sd,title = 'original leverage and SPE with 2 PCs')
