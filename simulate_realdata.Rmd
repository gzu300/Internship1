...
```{r plot 1:27}
plot_metabolites(df.final.masigpro,54:55)
...
asca.selected <- plot.leverage_spe(asca.fitted,sd,size=6,tag = 'A')
...
save(list = c('df.var.realdata','asca.selected','asca.original.selected','improved_loading.pc1','original_loading.pc1'),file = 'data.RData')
```
