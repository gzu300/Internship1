...
plot.mean_sd <- function(df){
  ...
  plot(mean_sd[1:560],mean_sd[561:1120],type = 'p')
...
```{r}
plot_a_metabolite(df.final.masigpro,mean,"Adenosine")
...
masigpro.fit <- maSigPro(df.final,masigpro.design,degree=degree)
